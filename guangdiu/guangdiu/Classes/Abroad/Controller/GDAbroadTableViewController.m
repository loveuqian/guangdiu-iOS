...
@interface GDAbroadTableViewController ()
...
@implementation GDAbroadTableViewController
...
- (void)loadData
{
    GDWeakSelf;
    self.listArray = nil;
    [self.manager GET:@"http://guangdiu.com/api/getlist.php?country=us&count=30"
           parameters:nil
             progress:nil
